                ...
                <p class="text-start">     
                    <form id="login">   
                        <div class="mb-3 text-start">
                            ...
                            <input type="email" class="form-control" name="user" id="user" placeholder="name@example.com"></br>

                            <!-- Pulando linha -->

                            <label for="inputPassword5" class="form-label">Senha</label>
                            <input type="password" name="senha" id="senha" class="form-control" aria-labelledby="passwordHelpBlock"></br>

                            <!-- Pulando linha -->

                            <button type="submit" class="btn btn-primary" for="btn-check" style="background-color: #20C997" data-bs-theme="light" id="submit">Enviar</button>
                        </div>
                    </form>
                </p>
            </div>
