    ...
    <div class="container text-center bg-body-tertiary">
        ...
        <div class="row">
            ...
            <div class="col bg-white">
                ...
                <p class="text-start fs-6">Informações de login.</p>
                <p class="text-start">     
                    <form>   
                        ...
                        <?php   
                            ...
                            if(!isset($_SESSION['login'])){
                                ...
                                if($user == $userCheck && $senha == $senhaCheck){
                                    ...
                                    echo '<span style="color: white;"> Dadoss Inválidos</span>';
